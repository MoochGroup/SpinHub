...
function Header() {
  ...
  return (
    ...
    <div className="Icon__Container">
      <div className="Icon"><span className="material-icons">settings</span></div>
      <div className="Account__Button">
      <HoverCard>
        <HoverCardTrigger asChild>
        <div className="Icon"><span className="material-icons">account_circle</span></div>
        </HoverCardTrigger>
        <HoverCardContent className="w-80">
          <div className="flex justify-between space-x-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
              Bob, the eccentric inventor with a penchant for speaking in rhymes.
              </p>
      ...
      <div className="Translate__Button">  
        <Popover>
          ...
          <div className="Icon"><span className="material-icons">translate</span></div>
          </PopoverTrigger>
